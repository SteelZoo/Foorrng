...
csv_df = pd.read_csv(r'C:\Users\SSAFY\Desktop\bigdata\flowPeople2.csv', encoding='cp949') # csv 파일을 저장했다.
...
# for i in range(50):
#     tmp = ([[random.randint(0, 10), random.randint(0, 10), random.randint(0, 10), random.randint(0, 10), random.randint(0, 10)]])
...
2. data_array_flow_town 
-> 동과 상대값에 대한 정보, 지하철 하차인구 비율

3. food_truck_manager_item
-> 점주가 판매하는 메뉴
...
# food_truck_manager_item = 'Takoyaki'
...
mydb = mysql.connector.connect(
  host="database-foorrng.cpcuiu0mwkgs.ap-northeast-2.rds.amazonaws.com",
  user="foorrng",
  password="foorrng205",
  database="foorrng"
)
